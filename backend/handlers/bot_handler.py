    ...
    if msg.text:
        ...
        if text == "/start":
            ...
            _telegram_send(chat_id,
                "👋 Welcome to **Gas-off** — Relationship Toxicity Analyzer!\n\n"
                "📌 **What is this?**\n"
                ...
                "4️⃣ Tap **Forward** → choose **Gas-off** → Send\n"
        ...
        if text == "/buystars":
            _telegram_send(
                chat_id,
                "💎 **Buy Telegram Stars**\n\n"
                "You need ⭐ Stars to subscribe to Gas-off Premium.\n\n"
...
def test_telegram():
    ...
    ok = _telegram_send(chat_id, "🧪 Gas-off diagnostic: all connections OK ✅")
